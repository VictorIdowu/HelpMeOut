$(document).ready(function(){
    ...
    chrome.storage.sync.get(null, function(result) {
        ...
        if ($("#"+result.type).attr("id") == "tab-only") {
           $("#"+result.type).find("img").attr("src", chrome.extension.getURL('./assets/images/popup/tab-only.svg'));
        } else if ($("#"+result.type).attr("id") == "desktop") {
           $("#"+result.type).find("img").attr("src", chrome.extension.getURL('./assets/images/popup/desktop.svg'));
    ...
    //toggle between toggle on and off
    // $(document).ready(function() {
    //     $(".slides").click(function() {
    //       var toggle1 = $(this).find(".toggle1");
    //       var toggle2 = $(this).find(".toggle2");
    //       toggle1.toggle();
    //       toggle2.toggle();
    //     });
    //   });
    ...
    //     $('#select-camera-button').click(function () {
    //       cameraActive = !cameraActive; // Toggle the camera state
    //       if (cameraActive) {
    //         // Turn on the camera
    //         startCamera();
    //       } else {
    ...
    //       // Toggle the button images for the camera button
    //       $('.toggle-camera.toggle1').toggle();
    //       $('.toggle-camera.toggle2').toggle();
    //     });
    
    //     // Handle microphone button click
    //     $('#select-microphone-button').click(function () {
    //       microphoneActive = !microphoneActive; // Toggle the microphone state
    //       if (microphoneActive) {
    ...
    //       // Toggle the button images for the microphone button
    //       $('.toggle-microphone.toggle1').toggle();
    //       $('.toggle-microphone.toggle2').toggle();
    //     });
    ...
    //           videoStream = stream;
    //           // You can use the videoStream for video processing or display
    ...
    //         .then(function (stream) {
    //           audioStream = stream;
    //           // You can use the audioStream for audio processing or recording
    ...
    $(document).on("click", ".type:not(.type-active)", function(){
       ...
       if ($(this).attr("id") == "tab-only") {
           $(this).find("img").attr("src", chrome.extension.getURL('./assets/images/popup/tab-only.svg'));
       } else if ($(this).attr("id") == "desktop") {
           $(this).find("img").attr("src", chrome.extension.getURL('./assets/images/popup/desktop.svg'));
